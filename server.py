...
print(f"Time taken for Initialization: {time.time() - tat}")
...
def face_detect(images):
	...
	with open("face_det_results.pkl", "rb") as f:
...
async def handle_message(data, websocket):
	...
	for i, (img_batch, mel_batch, frames, coords) in enumerate(tqdm(gen, 
		...
		with torch.no_grad():
			...
			print(f"Time taken for inference: {time.time() - ta}")
	...
	# out.release()
	print(f"Time taken for inference: {time.time() - tat}")
